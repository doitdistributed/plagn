...
PlagAmqp::PlagAmqp(const boost::property_tree::ptree & propTree,
    ...
    Plag(propTree, name, id, PlagType::AMQP)
{
    readConfig();
}
...
/**
 *-------------------------------------------------------------------------------------------------
 * @brief Destroy the PlagAmqp object
 * 
 */
PlagAmqp::~PlagAmqp()
{
...
/**
 *-------------------------------------------------------------------------------------------------
 * @brief PlagAmqp::init() configures the interface
 * 
 */
...
/**
 *-------------------------------------------------------------------------------------------------
 * @brief PlagAmqp::loopWork regularly reads on the socket, if data popped in or sends data
 * 
 */
